...
from .routes import cities, familiarization, ingestion

app = FastAPI(
    title="Inside Airbnb · London Pipeline",
    version="0.2.0",
    description=(
        "FastAPI surface over the Dataset Familiarization and "
        "Data Ingestion & Profiling layers. Read endpoints serve "
