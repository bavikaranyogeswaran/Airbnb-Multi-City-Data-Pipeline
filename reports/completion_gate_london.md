# Single-City Completion Gate — London
...
| # | Check | Status | Detail |
|---|-------|--------|--------|
| 1 | raw_download | ✅ PASS | All 5 raw files present. listings.csv.gz: 48.1MB, reviews.csv.gz: 246.1MB, calendar.csv.gz: 77.8MB, neighbourhoods.csv:  |
...
| 4 | silver_parquet | ✅ PASS | All 6 processed files present. listings_clean.parquet: 50.1MB, reviews_clean.parquet: 345.8MB, calendar_clean.parquet: 1 |
...
| 6 | duckdb_builds | ✅ PASS | warehouse.duckdb (138.3MB) — all 8 tables present: ['data_quality_result', 'dataset_version', 'dim_city', 'dim_date', 'd |
...
| 13 | decision_logs | ✅ PASS | All decision docs present: ['engineering_decisions.md (16.1KB)', 'assumptions_log.md (15.4KB)', 'eda_findings.md (22.9KB |
...
```
All 5 raw files present. listings.csv.gz: 48.1MB, reviews.csv.gz: 246.1MB, calendar.csv.gz: 77.8MB, neighbourhoods.csv: 0.0MB, neighbourhoods.geojson: 1.0MB
```
...
```
All 6 processed files present. listings_clean.parquet: 50.1MB, reviews_clean.parquet: 345.8MB, calendar_clean.parquet: 14.6MB, neighbourhoods_clean.parquet: 0.0MB...
```
...
```
warehouse.duckdb (138.3MB) — all 8 tables present: ['data_quality_result', 'dataset_version', 'dim_city', 'dim_date', 'dim_host', 'dim_listing', 'dim_neighbourhood', 'fact_calendar', 'fact_listing_snapshot', 'fact_reviews', 'pipeline_run', 'pipeline_stage_run']
```
...
```
All decision docs present: ['engineering_decisions.md (16.1KB)', 'assumptions_log.md (15.4KB)', 'eda_findings.md (22.9KB)']
```
