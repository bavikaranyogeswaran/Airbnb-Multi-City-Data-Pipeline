# Single-City Completion Gate — Berlin
...
| # | Check | Status | Detail |
|---|-------|--------|--------|
| 1 | raw_download | ✅ PASS | All 5 raw files present. listings.csv.gz: 6.9MB, reviews.csv.gz: 69.2MB, calendar.csv.gz: 11.5MB, neighbourhoods.csv: 0. |
...
| 4 | silver_parquet | ✅ PASS | All 6 processed files present. listings_clean.parquet: 6.7MB, reviews_clean.parquet: 96.9MB, calendar_clean.parquet: 2.1 |
...
| 6 | duckdb_builds | ✅ PASS | warehouse.duckdb (29.0MB) — all 8 tables present: ['data_quality_result', 'dataset_version', 'dim_city', 'dim_date', 'di |
...
```
All 5 raw files present. listings.csv.gz: 6.9MB, reviews.csv.gz: 69.2MB, calendar.csv.gz: 11.5MB, neighbourhoods.csv: 0.0MB, neighbourhoods.geojson: 0.7MB
```
...
```
All 6 processed files present. listings_clean.parquet: 6.7MB, reviews_clean.parquet: 96.9MB, calendar_clean.parquet: 2.1MB, neighbourhoods_clean.parquet: 0.0MB...
```
...
```
warehouse.duckdb (29.0MB) — all 8 tables present: ['data_quality_result', 'dataset_version', 'dim_city', 'dim_date', 'dim_host', 'dim_listing', 'dim_neighbourhood', 'fact_calendar', 'fact_listing_snapshot', 'fact_reviews', 'pipeline_run', 'pipeline_stage_run']
```
