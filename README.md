...
| §12 PDF Report | 20-page written report covering all 15 mandatory sections | `reports/airbnb_intel_report.pdf` — generated by `python scripts/generate_report.py` |
| §11 Presentation Deck | 14-slide PPTX deck (also HTML version) summarising methodology and findings | `reports/presentation.pptx`, `reports/presentation.html` — generated by `python scripts/generate_presentation.py` |
...
| §10 AI Usage Disclosure | Claude Code (claude-sonnet-4-6) as primary assistant; Groq in-product; per-section breakdown, key prompts, validation, rejections | `reports/ai_usage_disclosure.md` |
